...
console.log(sum(3, 5)); // Output: 8`
    ...
    return (
        <Flex className={ 'min-h-full relative items-center overflow-hidden' } gap={ '6' }>
            <Flex direction={ 'column' } className={ 'w-full px-6 sm:px-24 max-w-[47rem] z-50 justify-center relative' }>
                <Box position={ 'absolute' } className={ '-z-10 max-w-[37rem] w-full h-dvh bg-opacity-15 backdrop-blur-sm' } />
