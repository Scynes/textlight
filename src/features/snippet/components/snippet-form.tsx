            ...
            <Container size={ '2' }>
                <form action={ submitSnippet } className={ 'flex gap-4 flex-col' }>
                    ...
                    <Flex direction={ 'column' } className={ 'rounded-md border border-[--gray-7]' }>
                        <Flex onClick={ () => setSettingsOpen(!settingsOpen) } className={ `transition-all w-full h-10 cursor-pointer px-4 select-none text-[--gray-10] hover:text-white` } align={ 'center' } justify={ 'between' }>
